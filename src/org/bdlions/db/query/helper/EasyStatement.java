 ...
 */
package org.bdlions.db.query.helper;
...
public class EasyStatement implements Statement {
    ...
    public void setNull(String name, int sqlType) throws SQLException {
        ...
        for (int i = 0; i < indexes.length; i++) {
            ...
            logger.debug("Set value:null to column: {} at indexes[{}]", new Object[]{name, indexes[i]});
        }
    }
     ...
     * @throws SQLException if an error occurred
     * @throws IllegalArgumentException if the parameter does not exist
     * @see PreparedStatement#setString(int, Boolean)
     */
